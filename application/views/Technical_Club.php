              ...
              <div class="row mt-10">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-20 p-20 pt-0 wow fadeInUp" data-wow-duration="1s"
                 ...
                 <img src="<?php echo base_url();?>assets/images/facilities/club/Technical CLub.png" alt="shuttle"
                    ...
                    <li class="text-justify"> Providing a base for technical development and enhancement of technical knowledge.</li>
                    <li class="text-justify"> Escalate student’s chances in competitive examinations</li>
                    </ul>
                    </div>
                    <div class="col-md-12">
                    <ul class="list theme-colored angle-double-right">
                    <li class="text-justify">Enhance the student’s interest in modern technologies by conducting various competitions, symposiums, conferences, etc.</li>
                    <li class="text-justify">Handling projects to cater to the needs of the present generation.</li>
                    </ul>
