          ...
          <div class="row">
            <div class="col-md-9 pull-right flip sm-pull-none">
              <div class="row mt-10">
			    ...
			    <div class="row py-2">
						<div class="col-md-3 order-md-2 mb-4 mb-lg-0">
						    <span class="img-thumbnail d-block">
							    <img src="<?=base_url();?>assets/images/messages/jagadeesh_seceratary.jpg" class="img-fluid" alt="secretary">
							</span>
						</div>
			    ...
			    <div class="row">
        		    <div class="col">
        		        <p class="text-justify">Malnad College of Engineering is one of the premier institutions in the country serving the field of Technical education since 1960. The college is bringing out this information Handbook for the year 2024-2029. I am happy to observe that this book is comprehensive and clear with regard to the structure, governance, and rules of autonomous programs of the College. This handbook would be of great help for the students, faculty, and staff of the college. I wish that all the students make the best use of this handbook.</p>
                        <p class="text-justify"><strong style="  color:#c02140;">Sri.C.R.Jagadeesh</strong><br /><strong style="  color:#c02140;">Hon. Secretary,</strong><br> Board of Governors,<br />Malnad College of Engineering, <br />Hassan-573202</p>    
            </div>
        		</div>
