                ...
                <div class="row">
                    <div class="col-md-9 blog-pull-right">
                        ...
                        <ul id="researchTab" class="nav nav-tabs boot-tabs">
                            ...
                            <li class=""><a href="#publications" class="tabBorderDesign" data-toggle="tab">Student Publications</a></li>
                            <li class=""><a href="#collaborations" class="tabBorderDesign" data-toggle="tab">Collaboration/MOU's</a></li>
                            <li class=""><a href="#patents" class="tabBorderDesign" data-toggle="tab">Patents & Book Chapters</a></li>
                        </ul>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="patents">
                                <div class="row multi-row-clearfix">
                                    <div class="col-sm-12 col-md-12 text-left sm-text-center">
                                        <?php
                                        $researchCollaborations = $this->admin_model->getDetailsbyfield($dept_id, 'dept_id', 'research_patents')->result();
                                        if ($researchCollaborations != null) {
                                        ?>
                                            ...
                                            <table id="researchTable" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php foreach ($researchCollaborations as $researchCollaborations1) { ?>
                                                        <tr>
                                                            <td><?= $researchCollaborations1->title; ?></td>
                                                            <td>
                                                                <?php
                                                                if ($researchCollaborations1->type) {
                                                                    if ($researchCollaborations1->type == 1) {
                                                                        echo "Patent";
                                                                    } else {
                                                                        echo "Book Chapters";
                                                                    }
                                                            ...
                                                            <td><?= $researchCollaborations1->description; ?></td>
                                                           
                                                            <td>
                                                            <?php
                                                                if ($researchCollaborations1->file_names) {
                                                                    $fileNames = unserialize($researchCollaborations1->file_names);
                                                                    foreach ($fileNames as $key => $value) {
                                                                        echo '<a href="' . base_url('assets/departments/' . $short_name . '/research/' . $value) . '" target="_blank">' . $value . '</a><br>';
                                                                    }
                                                                }
                                                                ?>
                                                                <br>
                                                                <?php
                                                                if ($researchCollaborations1->link) {
                                                                    echo '<a href="' . $researchCollaborations1->link . '" target="_blank">' . $researchCollaborations1->link . '</a>';
                                                                }
                                                                ?>
                                                            </td>
                                                        </tr>
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(function() {
                                                    $('#researchTable').DataTable({
                                                        ...
                                                        "lengthMenu": [10, 25, 50, 75, 100], // Options for records per page
                                                        "searching": true, // Enable searching
                                                        "ordering": true, // Enable sorting
                                                        "info": true // Display info about pagination
                                                    });
                                                });
                                            </script>
                                        <?php } ?>
