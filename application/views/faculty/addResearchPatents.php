                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php
                                $Types = array(' '=>'Select Type','1' => 'Patent', '2' => 'Book chapter`s');
                                echo form_dropdown('type', $Types, $type, 'class="form-control form-control-sm" id="type"'); ?>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php echo anchor('faculty/researchPatents','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                            </div>
                        </div>
                    </div>
                </div>
