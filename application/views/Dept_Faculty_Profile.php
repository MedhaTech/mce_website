                        ...
                        <article class="post clearfix">
                            ...
                            <div class="col-sm-9">
                                <div class="">
                                    ...
                                    <h5 class="entry-title mt-0 mb-0 pt-0">Google Scholar Link : <a href="<?= $faculty->google; ?>"> Click here </a></h5><br>
                                    <h5 class="entry-title mt-0 mb-0 pt-0">IRINS link : <a href="<?= $faculty->irins; ?>"> Click here </a></h5>
                                    ...
                                    <h5 class="no-print">
                                        ...
                                        <a onclick="convertToPDF()" class="text-danger" style="cursor: pointer;"><i class="fa fa-download"></i> Download Profile</a>
