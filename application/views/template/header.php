...
<body class="">
  <div id="wrapper" class="clearfix">
    ...
    <header id="header" class="header">
              ...
              <div class="widget no-border m-0">
                <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                  <li class="mt-sm-10 mb-sm-10">
                    ...
                    <a class="btn btn-default btn-flat btn-xs bg-light p-5 font-11 pl-10 pr-10 font-weight-700" target="blank" href="https://admissions.mcehassan.ac.in/">Admission 2025-26 (MGMT)</a>
                  </li>
                  <li class="mt-sm-10 mb-sm-10">
                    <!-- Modal: Appointment Starts -->
                  ...
                  <!-- <li class="mt-sm-10 mb-sm-10">
                    <a class="btn btn-default btn-flat btn-xs bg-danger p-5 font-11 pl-10 pr-10" href="https://canarabank.com/NET_Banking.aspx" target="_blank" class="blink">Online Payment</a>
                    
                  </li> -->
                  <li class="mt-sm-10 mb-sm-10">
                    <a class="btn btn-warning btn-flat btn-xs bg-warning p-5 font-11 pl-10 pr-10 blink" href="https://campus.mcehassan.ac.in/" target="_blank">Online Payment</a>
                  </li>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-9 col-md-7">
              <div class="col-xs-12 col-sm-12 col-md-12 mb-15 mt-5">
                <div class="widget no-border m-0">
                  <ul class="list-inline sm-text-center pull-right top-menu">
                    ...
                    <li>
                      ...
                      <!-- <?php echo anchor('home/MERIIISE', 'ME-RIISE Foundation'); ?> -->
                      <!-- <a href="http://www.meriise.org/" target="blank">ME-RIISE Foundation</a> -->
                      <a href="https://mceparents.contineo.in/" target="_blank">Student contineo portal</a>
                    </li>
                    <!-- <li class="">|</li> -->
                    <li>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="widget no-border m-0">
                  <div class="accreditations-brand text-right sm-text-center">
                    ...
                    <!-- <?php echo anchor('http://www.meriise.org/uba.html', '<img src="' . base_url() . 'assets/images/accreditations/UBA1.jpg">'); ?> -->
                    <a href="http://www.meriise.org/uba.html" target="_blank"><img src="<?= base_url(); ?>assets/images/accreditations/UBA1.jpg"></a>
                    <?php echo anchor('home/NAAC-Certificate', '<img src="' . base_url() . 'assets/images/accreditations/naac.jpg">'); ?>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="widget no-border m-0">
              <div class="accreditations-brand text-right sm-text">
              <ul class="styled-icons icon-dark mt-20 text-right">
      ...
      <style>
        .menuzord-menu ul.list-unstyled li a {
    color: #666666;
    font-size: 12px;
    font-weight: 600;
              ...
              <ul class="menuzord-menu">
                ...
                foreach ($navBar as $navBar) {
                  ...
                  if ($navBar->display) {
                    ...
                    // LEVEL 2 - SINGLE
                    if (isset($navBar->children) && $navBar->childrenDisplay && $navBar->name != 'Academics') {
                    ...
                    if (isset($navBar->children) && $navBar->childrenDisplay && $navBar->name == 'Academics') {
                      ...
                      echo '<div class="megamenu" style="right: 0px; display: none;">';
                      echo '<div class="megamenu-row">';
                  
                      $totalChildren = count($childrens);
                      $columns = 3;
                      $childrenPerColumn = ceil($totalChildren / $columns);
                  echo '<div class="col1"></div>';
                      for ($col = 0; $col < $columns; $col++) {
                          echo '<div class="col3">';
                  
                          $start = $col * $childrenPerColumn;
                          $end = min(($col + 1) * $childrenPerColumn, $totalChildren);
                          $columnChildren = array_slice($childrens, $start, $end - $start);
                  
                          echo '<ul class="list-unstyled list-dashed">';
                          foreach ($columnChildren as $children) {
                              if ($children->display) {
                                  if (isset($children->navigate)) {
                                      echo '<li><a href="' . $children->navigate . '" class="dropdown-item" target="_blank">';
                                      echo $children->name;
                                      echo '</a></li>';
                                  } else {
                                      if (isset($children->redirect)) {
                                      ...
                                      echo '<li><a href="' . base_url('home/' . $childrenLink) . '" class="dropdown-item">';
                                      echo $children->name;
                                      echo '</a></li>';
                                  }
                                  ...
                                  if (isset($children->children) && $children->subchildrenDisplay) {
                                      ...
                                      foreach ($subchildren as $subchildrenItem) {
                                          if ($subchildrenItem->display) {
                                              echo '<li><a href="' . base_url('home/' . preg_replace('/\s+/', '-', $subchildrenItem->name)) . '" class="dropdown-item">';
                                              echo $subchildrenItem->name;
                                              echo '</a></li>';
                                          }
                                      }
                                  }
