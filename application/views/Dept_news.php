                                ...
                                <div class="row">
                                    ...
                                    foreach ($fileNames as $key => $value) {
                                        ...
                                        if ($ext == "pdf") {
                                            ...
                                            echo "<p>$value : " . anchor('assets/departments/' . $short_name . '/latest_news/' . $value, '<i class="fa fa-fw fa-download"></i> Download', 'class="btn btn-danger btn-xs" target="_blank"') . '</p>';
                                    ?>
