                 ...
                 <table class="table ">
                    <tbody>
                        <?php $i=1;?>
                         <tr>
                            <td><?=$i++;?></td>
                            <td>MOU between Department of Computer Science and Business Systems,MCE and Tata Consultancy Services Limited(TCS)</td>
                            <td><?php echo anchor('assets/images/mou/Tata Consultancy Services Ltd..pdf','<i class="fa fa-eye"></i> View Here','class="btn btn-warning btn-sm" target="_blank"');?></td>
                        </tr>
                        <tr>
                            <td><?=$i++;?></td>
