                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="details">Document Details: <span class="text-danger">*</span></label>

                                <input type='text' name="details" id="details" class="form-control form-control-sm" value="<?php echo (set_value('name'))?set_value('name'):'';?>">
