        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <input type="text" class="form-control form-control-sm" id="news_title" name="news_title" placeholder="Add Title of the event here.." value="<?php echo (set_value('news_title')) ? set_value('news_title') : ''; ?>">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control form-control-sm" id="news_date" name="news_date" placeholder="" value="<?php echo (set_value('news_date')) ? set_value('news_date') : ''; ?>">
                    <span class="text-danger"><?php echo form_error('news_date'); ?></span>
                </div>

                <div class="form-group col-md-6">
                    <label for="details">Status</label>
                    <input type="text" class="form-control form-control-sm" id="news_details" name="news_details" placeholder="Status" value="<?php echo (set_value('news_details')) ? set_value('news_details') : ''; ?>">
                ...
                <div class="form-group mx-5">
                    <button type="submit" class="btn btn-danger btn-sm" name="Update" id="Update"><i class="fas fa-edit"></i> Create </button>
