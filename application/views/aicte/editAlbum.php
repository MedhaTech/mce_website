            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="details">Album Name: <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php $statusOptions = array('1'=>'Enable','0'=>'Disable');
                                    echo form_dropdown('status', $statusOptions, $Details->status, 'class="form-control form-control-sm" id="status"'); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor('aicte/albums','<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
