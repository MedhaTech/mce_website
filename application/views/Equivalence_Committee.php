              ...
              <div class="row mt-10">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-20 p-20 pt-0 wow fadeInUp" data-wow-duration="1s"
                  ...
                  <h3 class="line-bottom mt-0"> <span class="text-theme-colored">
                     <?=$activeMenu;?> </span></h3>
                   <!-- <h5 class="text-underline">Equivalence Committee (EC)</h5> -->
                    <p class="text-justify">EC shall decide the number of credits and grade points to be awarded, for the courses studied earlier, to the students from non-autonomous programs.</p>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Members: </td>
                             <td>Dean (AA),  HOD, Senior faculty nominated by the Principal</td>
                        </tr>
                         </tbody>
                    </table>
