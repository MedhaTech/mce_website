                 ...
                 <table class="table ">
                    <tbody>
                        ...
                        <tr>
                            <td><?=$i++;?></td>
                            <td><?= $docs->details;?></td>
                            <td> <?php echo anchor('assets/departments/MERIISE/documents/'.$docs->file_names,'<i class="fa fa-download"></i> View Here','class="btn btn-warning btn-sm" target="_blank"');?></td>
                        </tr>
                        <?php }?>
                    </tbody>
                </table>
