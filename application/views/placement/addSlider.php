...
<main id="main-container">
 ...
 echo form_open($action, 'class="user"  enctype="multipart/form-data"'); ?>
                <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php echo anchor($cancel,'<i class="fas fa-arrow-left fa-sm fa-fw"></i> Cancel', 'class="btn btn-dark btn-sm" '); ?>
                    </div>
                </div>
