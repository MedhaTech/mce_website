            ...
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <ol class="breadcrumb text-center text-black mt-10">
                  ...
                  <li class="active text-gray-silver">MHRD-IIC</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="row mt-10">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-20 p-20 pt-0 wow fadeInUp" data-wow-duration="1s"
                  ...
                  <h3 class="line-bottom mt-0"> <span class="text-theme-colored">
                     ...
                     <h4>   Institution's innovative council establishment certificate 2020-21</h4>
                <?php echo anchor('assets/files/MHRD-IIC/1.pdf','<i class="fa fa-download"></i> Download','class="btn btn-warning btn-sm" target="_blank"');?>
                <iframe src="<?=base_url();?>assets/files/MHRD-IIC/I I C  Certificates.pdf" width="100%" height="800px" style="padding:20px 0px"></iframe></br>
