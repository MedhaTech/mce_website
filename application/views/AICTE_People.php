    ...
    <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
            <div class="col-md-9 blog-pull-right">
                <h3 class="text-theme-colored text-uppercase mt-0">Faculty</h3>
                ...
                <?php foreach ($faculty as $faculty1) { 
                    ...
                    ?>
                <article class="post clearfix administration">
                  <div class="col-sm-3">
              ...
              <br>
              <h3 class="text-theme-colored text-uppercase mt-0">Staff</h3>
              <div class="row list-dashed mt-20">
                <?php foreach ($faculty as $faculty1) { 
                    if($faculty1->staff_type=='2')
                    {
                    $url = glob('./assets/departments/AICTE/faculty/profile_' . $faculty1->id . '-*.jpg');
                    $profile_pic = base_url() . $url[0];
                    ?>
              ...
              <br>
              <h3 class="text-theme-colored text-uppercase mt-0">Students' ambassadors</h3>
              <div class="row list-dashed mt-20">
                <?php foreach ($faculty as $faculty1) { 
                    if($faculty1->staff_type=='3')
                    {
                    $url = glob('./assets/departments/AICTE/faculty/profile_' . $faculty1->id . '-*.jpg');
                    $profile_pic = base_url() . $url[0];
                    ?>
