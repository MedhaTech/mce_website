			    ...
			    <div class="row py-2">
						<div class="col-md-3 order-md-2 mb-4 mb-lg-0">
						    <span class="img-thumbnail d-block">
							    <img src="<?=base_url();?>assets/images/Administration/Principal.jpg" class="img-fluid" alt="principal">
							</span>
						</div>
...
<p style=" text-align: justify;">Wishing you all the Best.</p>
                        <p class="text-justify"><strong style="  color:#c02140;">Dr.A.J. Krishnaiah</strong><br /><strong style="  color:#c02140;">Principal</strong> <br />Malnad College of Engineering, <br />Hassan-573202</p>    
            </div>
        		</div>
