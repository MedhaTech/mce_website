              ...
              <div class="row mt-10">
                <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-20 p-20 pt-0 wow fadeInUp" data-wow-duration="1s"
                  ...
                  <table class="table table-striped">
                    <thead>
                        <tr>
                            <th width="30%">Designation in TEQIP</th>
                            <th width="30%">NAME</th>
                            <th width="10%"></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i=1;?>
                            ...
                            <td>Dr.A.J. Krishnaiah<br>
 ksj@mcehassan.ac.in </td>
                            <td> <img class="img-responsive img-fullwidth img-thumbnail" src="<?=base_url().'assets/images/Administration/Principal.jpg'?>" alt="Dr. B . UMA"></td>
                        </tr>
                        <tr>
