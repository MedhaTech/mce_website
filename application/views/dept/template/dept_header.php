        ...
        <nav id="sidebar" aria-label="Main Navigation">
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <?php if ($username == 'academic@mcehassan.ac.in') { ?>
                            ...
                            <li class="nav-main-item">
                                <?php echo anchor('dept/aboutDepartment', '<i class="nav-main-link-icon si si-list"></i> <span class="nav-main-link-name">About Us</span>', 'class="nav-main-link ' . (($activeMenu == "aboutDept") ? "active" : "") . ' "');  ?>
                            </li>
                            <li class="nav-main-item">
                                <?php echo anchor('dept/faculty', '<i class="nav-main-link-icon si si-list"></i> <span class="nav-main-link-name">Dean Details</span>', 'class="nav-main-link ' . (($activeMenu == "faculty") ? "active" : "") . ' "');  ?>
                            </li>
                            <li class="nav-main-item">
                                <?php echo anchor('dept/latestNews', '<i class="nav-main-link-icon si si-list"></i> <span class="nav-main-link-name">Scroll News</span>', 'class="nav-main-link ' . (($activeMenu == "latestNews") ? "active" : "") . ' "');  ?>
                            </li>
                            <li class="nav-main-item">
                                <?php echo anchor('dept/albumImages/92', '<i class="nav-main-link-icon si si-list"></i> <span class="nav-main-link-name">Gallery</span>', 'class="nav-main-link ' . (($activeMenu == "albums") ? "active" : "") . ' "');  ?>
                            </li>
                            <li class="nav-main-item">
                                <?php echo anchor('dept/accreditedDocuments', '<i class="nav-main-link-icon si si-list"></i> <span class="nav-main-link-name">Documents</span>', 'class="nav-main-link ' . (($activeMenu == "accreditedDocuments") ? "active" : "") . ' "');  ?>
                            </li>
                        <?php } elseif ($username == 'first@mcehassan.ac.in') { ?>
                        ...
                        <?php } else { ?>
                            ...
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item">
                                        <?php echo anchor('dept/researchPatents', '<span class="nav-main-link-name">Research Patents</span>', 'class="nav-main-link"'); ?>
                                    </li>
