                    ...
                    <div class="col-md-8 offset-2">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="designation" id="designation" class="form-control" value="<?php echo (set_value('designation'))?set_value('designation'):'';?>">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="position" id="position" class="form-control" value="<?php echo (set_value('position'))?set_value('position'):'';?>">
                                <?php echo form_error('position', '<div class="error">', '</div>'); ?>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="details">Organisation/Nominated: </label>
                                <input type="text" name="organisation" id="organisation" class="form-control" value="<?php echo (set_value('organisation'))?set_value('organisation'):'';?>">
                                <?php echo form_error('organisation', '<div class="error">', '</div>'); ?>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="details">Sort Order: </label>
                                <input type="text" name="order" id="order" class="form-control" value="<?php echo (set_value('order'))?set_value('order'):'';?>">
                                <?php echo form_error('order', '<div class="error">', '</div>'); ?>
                            </div>

                            <div class="form-group col-md-12">
                                <label for="details">Email: </label>
                                <input type="text" name="email" id="email" class="form-control" value="<?php echo (set_value('email'))?set_value('email'):'';?>">
