            ...
            <div class="card-body">
                ...
                <div class="row  mx-5">
                    <div class="form-group col-md-6">
                        ...
                        <ul class="mt-3">
                            ...
                            foreach ($fileNames as $key => $value) {
                                $del = anchor('dept/latestNewsDelete/' . $Details->id . '/' . $key, '<i class="fa fa-times ml-2 text-danger"></i>', 'class=""');
                                echo '<li>' . anchor('assets/departments/' . $short_name . '/latest_news/' . $value, $value, 'target="_blank"') . '&nbsp;' . $del . '</li>';
                            }
                            ?>
                        </ul>
                    </div>
                    <div class="form-group mx-5 col-md-3">
                        ...
                        YES <input type="radio" class="" id="new_label" name="new_label" <?php if ($Details->new_label == 1) {
                                                                                                echo "checked";
                                                                                            } ?> value="1">
                        NO <input type="radio" class="" id="new_label" name="new_label" <?php if ($Details->new_label == 0) {
                                                                                            echo "checked";
                                                                                        } ?> value="0">
                        <?php echo form_error('new_label', '<div class="error">', '</div>'); ?>
                    </div>
