    ...
    <div class="container mb-0 pt-0 mt-20">
      <div class="section-content">
        <div class="row mt-10">
          ...
          <h4 class="text-theme-colored"><a href="https://campus.mcehassan.ac.in/student" class="text-theme-colored text-capitalize" target="blank"><img src="<?php echo base_url(); ?>assets/images/blinking_new.gif"></img> Student Login URL for Online Fees Payment</a> | <a href="<?= base_url(); ?>assets/Documents and Affidavit.pdf" class="text-theme-colored" target="blank"><img src="<?php echo base_url(); ?>assets/images/blinking_new.gif"></img>List of Documents and Affidavit format - To be Produced during the time of Admission 2025-26 </a> </h4>
          </marquee>
          <!-- <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
