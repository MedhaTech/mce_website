            ...
            <div class="col-md-9 pull-right flip sm-pull-none">
              <div class="row mt-10">
                ...
                <div class="col-md-7">
                    ...
                    <p class="text-justify">MCE Network Control Center holds all network activities carried out in the MCE campus with proper security devices. This MCE-NCC helps staffs & students to access free Wi-fi facility within the campus.<strong><mark>Currently we are having 1000 Mbps of dedicated leased line</mark></strong> <?php echo anchor('assets/images/network/1Gbps.jpeg','<i class="fa fa-eye"></i> Click here','class="btn btn-warning btn-sm" target="_blank"');?> </p>
                    </div>
