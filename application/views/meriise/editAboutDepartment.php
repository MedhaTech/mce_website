        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mx-3">
                    ...
                    <textarea id="vision" name="vision" class="form-control  col-lg-12" rows=6><?php echo (set_value('vision')) ? set_value('vision') : $departmentsDetails->vision; ?></textarea>
                    <script>
                ...
                <div class="form-group row mx-3">
                    ...
                    <textarea id="about" name="about" class="form-control col-lg-12" rows=6><?php echo (set_value('about')) ? set_value('about') : $departmentsDetails->about; ?></textarea>
                    <script>
