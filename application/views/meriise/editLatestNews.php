            ...
            <div class="card-body">
                ...
                <div class="row  mx-5">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" class="form-control form-control-sm" id="news_date" name="news_date"  placeholder="Add news title here.."    value="<?php echo (set_value('news_date'))?set_value('news_date'):date("Y-m-d", strtotime($Details->news_date));?>">
