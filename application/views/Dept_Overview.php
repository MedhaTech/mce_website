      ...
      <div class="section-content">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="title text-white"><?= $parentMenu; ?> <?php if($parentMenu=="Computer Science and Business Systems"){ echo " (TCS Sponsored Program) ";}?></h2>
          ...
          <div class="row list-dashed">
            <div class="col-md-12 pt-10 pb-10">
              <div class="widget no-border m-0">
                <b>Latest News & Events (<a href="<?php echo base_url(); ?>home/News-and-Events/<?=$dept_name_id;?>">View All</a>) :</b>
