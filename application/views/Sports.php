...
<tr>
  ...
  <img src="<?php echo base_url();?>assets/files/sports/swimming.jpg" alt="shuttle"
                ...
                <div class="col-md-12">
                    ...
                    <h4>
                    Calendar of VTU Inter Collegiate sports/games for the year 2024-25 <?php echo anchor('assets/files/sports/VTU-Sports-Calendar-2024-25.pdf','<i class="fa fa-eye"></i> Click here','class="btn btn-warning btn-sm" target="_blank"');?></h4>                    
                    <h4>
                    Circular regarding college Team selection process to VTU Inter Collegiate sports/games for the year 2024-25 <?php echo anchor('assets/files/sports/Sports selection.pdf','<i class="fa fa-eye"></i> Click here','class="btn btn-warning btn-sm" target="_blank"');?></h4>
                    

<!-- <p><b>
Students Annual Sports Report 2023-2024<?php echo anchor('assets/files/sports/annual report 2023-24 .pdf','<i class="fa fa-eye"></i> Click here','class="btn btn-warning btn-sm" target="_blank"');?></b></p>
<p><b>
Sports & Games Facilities<?php echo anchor('assets/files/sports/MCE Sports Facilitys.pdf','<i class="fa fa-eye"></i> Click here','class="btn btn-warning btn-sm" target="_blank"');?></p></p>
                -->
