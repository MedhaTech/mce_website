    ...
    <div class="container mt-30 mb-30 pt-30 pb-30">
      <div class="row">
        <div class="col-md-8 pull-right flip sm-pull-none">
                    ...
                    <div class="gallery-item wheel">
                      <div class="work-gallery">
                        <div class="gallery-thumb">
                          <img class="img-fullwidth" alt="" src="<?= base_url(); ?>assets/departments/AICTE/albums/<?= $img->file_names; ?>">
                          <div class="gallery-overlay"></div>
                          <div class="gallery-contect">
                            <ul class="styled-icons icon-bordered icon-circled icon-sm">

                              <li><a data-rel="prettyPhoto" href="<?= base_url(); ?>assets/departments/AICTE/albums/<?= $img->file_names; ?>"><i class="fa fa-arrows"></i></a></li>
                            </ul>
                          </div>
                        </div>
          ...
          <?php
            $url = base_url() . 'home/AICTE-Gallery/' ;
