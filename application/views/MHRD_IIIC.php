        ...
        <div class="col-md-9 pull-right flip sm-pull-none">
          <div class="row mt-10">
            ...
            <!--  <img src="<?php echo base_url(); ?>assets/images/IIC/RatingCertificate_2022-23_page-0001 (1) - Copy.jpg" width="20px" height="20px" alt="NAIN" class="img-responsive img-fullwidth img-thumbnail"> -->
             ...
             <h4>Certificates of Recognition& IIC, MENTOR-MENTEE SCHEEME</h4>
                <iframe src="<?=base_url();?>assets/files/MHRD-IIC/I I C  Certificates.pdf" width="100%" height="800px" style="padding:20px 0px"></iframe>
