                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <ol class="breadcrumb text-center text-black mt-10">
                            ...
                            <li class="active text-gray-silver">Humanities</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td width="291">
                                            <p><strong>CONSTITUTION OF ETHICS COMMITTEE</strong></p>
                                        </td>
                                        <td width="111">
                                            <p><strong><a href=" <?php echo base_url();?>assets/files/RESEARCH/constitution ethics committee.pdf">CLICK HERE</a></strong></p>
                                        </td>
                                    </tr>
                                 <tr>
                                        <td width="39">
                                        ...
                                        <td width="291">
                                            <p><strong>RESEARCH ADVISORY COMMITTEE</strong></p>
                                        </td>
                                        <td width="111">
                                            <p><strong><a href=" <?php echo base_url();?>assets/files/RESEARCH/Research advisory committee.pdf">CLICK HERE</a></strong></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table> -->
<div class="row list-dashed mt-20">
         <p><h4>List of faculties handling different coursers under department of humanities<?php echo anchor('assets/files/Humanities.pdf','<i class="fa fa-eye"></i> Click here','class="btn btn-warning btn-sm" target="_blank"');?></h4></p> 
</div>
                ...
                <tbody>
                    ...
                    <td>
                      <p><strong>Course Name with Code</strong></p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <p>Contractual Employee</p>
                    </td>
                    <td>
                      <p>Samskruthika Kannada-22SK17/27</p>
                    </td>
                  </tr>
                           <tr>
                    <td>
                    ...
                    <td>
                      <p>SGnanashree Degowl</p>
                    </td>
                    <td>
                      <p>Contractual Employee</p>
                    </td>
                    <td>
                      <p>Communicative English-22ENG16

Professional Writing Skills in English- 22PWS26
</p>
                    </td>
                      <tr>
                    <td>
                    ...
                    <td>
                      <p>Zoya Farheen T M</p>
                    </td>
                    <td>
                      <p>Contractual Employee</p>
                    </td>
                    <td>
                      <p>Indian Constitution- 22ICO27
</p>
                    </td>
                  </tr>
                          <tr>
                    ...
                    <td>
                      <p>Constitution of India and Professional Ethics-21CIP
</p>
                    </td>
                  </tr>
                 </tbody>
