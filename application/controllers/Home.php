...
class Home extends CI_Controller
{
	...
	public $designationType = array("" => "", "1" => "Professor", "2" => "Associate Professor", "3" => "Assistant Professor", '4' => 'Dean Academic Affairs', '5' => 'Associate Dean Academic Affairs');
	...
	public function Vicechairman_Message()
	{
		$data['mainMenu'] = 'About Us';
		$data['parentMenu'] = 'Messages';
		$data['activeMenu'] = "Vice-Chairman Message";
	...
	public function Director_Message()
	{
		$data['mainMenu'] = 'About Us';
		$data['parentMenu'] = 'Messages';
		$data['activeMenu'] = "Director Message";
		$this->template->show('Director_Message', $data);
	}
	...
	public function AQAR_Reports_2023()
	{
		$data['mainMenu'] = 'Other Committee';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "AQAR Reports 2023-24";
		$this->template->show('AQAR_Reports_2023', $data);
	}
	...
	public function IQAC_MOMS()
	{
		...
		$data['documents']  = $this->admin_model->getDetailsbyfieldSort('23', 'dept_id', 'id', 'asc', 'accredited_documents')->result();
	...
	public function AQAR_Reports()
	{
		...
		$data['documents']  = $this->admin_model->getDetailsbyfieldSort('23', 'dept_id', 'id', 'desc', 'aqar_reports')->result();
	...
	public function AQAR_Documents()
	{
		...
		$data['documents']  = $this->admin_model->getDetailsbyfieldSort('23', 'dept_id', 'academic_year', 'desc', 'aqar_documents')->result();
	...
	public function Newsletter()
	{
		$data['mainMenu'] = 'Admissions';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Newsletter";
		$this->template->show('Newsletter', $data);
	}
	...
	public function Circulars()
	{
		...
		$data['circulars'] = $this->admin_model->getDetailsbyfieldSort('22', 'dept_id', 'id', 'desc', 'accredited_documents')->result();
		// $this->admin_model->getDetailsbyfieldSort('21', 'dept_id','id','desc', 'accredited_documents')->result();
	...
	public function Training_And_Placements_Overview()
	{
		$data['mainMenu'] = 'Training and Placements';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Training And Placements Overview";
	...
	public function Placement_Records()
	{
		...
		$data['placement']  = $this->admin_model->getDetailsbyfieldSort('21', 'dept_id', 'id', 'desc', 'accredited_documents')->result();
		$this->template->show('Placement_Records', $data);
	}

	public function Soft_Skill_Social_Skill()
	{
		$data['mainMenu'] = 'Training and Placements';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Soft Skill-Social Skill";
		$data['Details'] = $this->admin_model->getDetailsbyfield('21', 'dept_id', 'events')->result();
		$this->template->show('soft_skill', $data);
	}
	...
	public function IUCEE_EWB_CLUB()
	{
		$data['mainMenu'] = 'Facilities';
		$data['parentMenu'] = 'Clubs';
		$data['activeMenu'] = "IUCEE EWB CHAPTER";
		$this->template->show('IUCEE_EWB_CLUB', $data);
	}
	...
	public function IT_Infrastructure()
	{
		$data['mainMenu'] = 'Other Wings';
		$data['parentMenu'] = 'Facilities';
		$data['activeMenu'] = "IT-Infrastructure";
	...
	public function AICTE_IDEA_Lab()
	{
		...
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Home";
		$data['sliders'] = $this->admin_model->getDetailsbyfield('25', 'dept_id', 'sliders')->result();
	...
	public function AICTE_People()
	{
		...
		$data['faculty'] = $this->admin_model->getDetailsbyfieldSort('25', 'dept_id', 'name', 'asc', 'faculty')->result();
		// $data['faculty'] = $this->admin_model->getDetailsbyfield('25', 'dept_id', 'faculty')->result();
		$this->template->show('AICTE_People', $data);
	}

	public function AICTE_Facility()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Facility";
		$data['docs'] = $this->admin_model->getDetailsbyfield('1', 'id', 'docs')->row();
		$this->template->show('AICTE_Equipments', $data);
	}

	public function AICTE_Projects()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Projects";
		$data['docs'] = $this->admin_model->getDetailsbyfield('2', 'id', 'docs')->row();
		$this->template->show('AICTE_projects', $data);
	}

	public function AICTE_Incubation()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Incubation & Entrepreneurial";
		$data['docs'] = $this->admin_model->getDetailsbyfield('3', 'id', 'docs')->row();
		$data['docs1'] = $this->admin_model->getDetailsbyfield('4', 'id', 'docs')->row();
		$this->template->show('AICTE_Incubation', $data);
	}

	public function AICTE_Research()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Research & Consultancy";
		$data['docs'] = $this->admin_model->getDetailsbyfield('5', 'id', 'docs')->row();
		$data['docs1'] = $this->admin_model->getDetailsbyfield('6', 'id', 'docs')->row();
		$this->template->show('AICTE_Research', $data);
	}
	public function AICTE_Products()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "List of Products";
		$data['Details'] = $this->admin_model->getDetailsbyfield('25', 'dept_id', 'newsletters')->result();
		// $data['docs'] =$this->admin_model->getDetailsbyfield('7', 'id', 'docs')->row();
		$this->template->show('AICTE_Products', $data);
	}
	public function AICTE_Publications()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Publications";
		$data['docs'] = $this->admin_model->getDetailsbyfield('8', 'id', 'docs')->row();
		$this->template->show('AICTE_Publications', $data);
	}
	...
	public function AICTE_Events()
	{
		...
		$data['documents'] = 	$this->admin_model->getDetailsbyfield2sort_new('display_in', '4', 'dept_id', '25', 'events', 'news_date', 'DESC')->result();
		$this->template->show('AICTE_Events', $data);
	}

	public function AICTE_Achievements()
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Achievements & Appreciations";
		// $data['documents'] = $this->admin_model->getDetailsbyfield('29', 'dept_id', 'events')->result();
		$data['documents'] = 	$this->admin_model->getDetailsbyfield2sort_new('display_in', '3', 'dept_id', '25', 'events', 'news_date', 'DESC')->result();
		$this->template->show('AICTE_Achievements', $data);
	}
	...
	public function AICTE_Gallery()
	{
		...
		$data['dept_name'] = "AICTE";
		$data['id'] = 25;
		$data['dept_id'] = $this->globals_model->departmentId($data['dept_name']);
		$data['albums'] = $this->admin_model->getDetailsbyfield('25', 'dept_id', 'albums')->result();
	...
	public function NAAC()
	{
		...
		switch ($data['link']) {
			...
			case 15:
				...
				break;
			case 17:
				$data['activeMenu'] = "Naac Certificate From 2024-2029";
	...
	public function cycle2_DVV_Clarification_1()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "DVV Clarification-1";
		$this->template->show('cycle2_DVV_Clarification', $data);
	}
	public function RE_DVV()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "RE-DVV";
		$this->template->show('DVV_Clarification2', $data);
	}

	public function cycle2_RE_DVV()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "RE-DVV";
		$this->template->show('cycle2_DVV_Clarification2', $data);
	}
	...
	public function cycle2_Extended_Profile()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Extended Profile";
		$this->template->show('Cycle2_Extended_Profile', $data);
	}
	...
	public function Cycle2_Curricular_Aspects()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Curricular Aspects";
		$this->template->show('Cycle2_Curricular_Aspects', $data);
	}
	...
	public function cycle2_Teaching_Learning_and_Evaluation()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Teaching Learning and Evaluation";
		$this->template->show('cycle2_Teaching_Learning_and_Evaluation', $data);
	}
	...
	public function cycle2_Research_Innovations_and_Extension()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Research, Innovations and Extension";
		$this->template->show('cycle2_Research_Innovations_and_Extension', $data);
	}
	...
	public function cycle2_Infrastructure_and_Learning_Resources()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Infrastructure and Learning Resources";
		$this->template->show('cycle2_Infrastructure_and_Learning_Resources', $data);
	}
	...
	public function cycle2_Student_Support_and_Progression()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Student Support and Progression";
		$this->template->show('cycle2_Student_Support_and_Progression', $data);
	}
	...
	public function cycle2_Governances_Leadership_and_Management()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Governances, Leadership and Management";
		$this->template->show('cycle2_Governances_Leadership_and_Management', $data);
	}
	...
	public function cycle2_Institutional_Values_and_Best_Practices()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Institutional Values and Best Practices";
		$this->template->show('cycle2_Institutional_Values_and_Best_Practices', $data);
	}
	...
	public function cycle2_Undertaking()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Undertaking";
		$this->template->show('cycle2_Undertaking', $data);
	}
	...
	public function Naac_Certificate()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "NAAC Certificate";
		$this->template->show('Naac_Certificate', $data);
	}
	...
	public function AICTE_Lab()
	{
		$data['mainMenu'] = 'Gallery';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Gallery";
		$this->template->show('AICTE_Lab', $data);
	}

	public function Graduation_2024()
	{
		$data['mainMenu'] = 'Gallery';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Gallery";
		$this->template->show('Graduation_2024', $data);
	}
	...
	public function QS_I_GAUGE()
	{
		...
		$data['parentMenu'] = false;
		$data['activeMenu'] = "QS I-GAUGE Rating";
	...
	{
		$data['mainMenu'] = 'ME-RIISE Foundation';
		$data['parentMenu'] = false;
		$data['activeMenu'] = 'Home';
		$data['documents'] = $this->admin_model->getDetailsbyfield2sort_new('display_in', '4', 'dept_id', '20', 'events', 'news_date', 'DESC')->result();
	...
	public function Startups()
	{
		...
		$data['documents'] = $this->admin_model->getDetailsbyfield2sort('display_in', '5', 'dept_id', '20', 'events', 'news_date', 'DESC')->result();
	...
	public function MERIISEEvents()
	{
		...
		$data['documents'] = $this->admin_model->getDetailsbyfield2sort_new('display_in', '4', 'dept_id', '20', 'events', 'news_date', 'DESC')->result();
		// $data['documents'] = $this->admin_model->getDetailsbyfield('20', 'dept_id', 'events')->row();
	...
	public function Researchs()
	{
		...
		$data['parentMenu'] = false;
		$data['activeMenu'] = "About Research";
		$this->template->show('Research_New', $data);
	}
		public function Research_2024()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Research 2024";
		$this->template->show('Research', $data);
	}

	public function Research_Centres()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Research_Supervisors_List.pdf';
		$data['activeMenu'] = "Research Centres";
		$this->template->show('research_data', $data);
	}

	public function Research_Publications()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Book_Chapters.pdf';
		$data['file_name1'] = 'Journal_Papers.pdf';
		$data['file_name2'] = 'Research_Publication.pdf';
		$data['activeMenu'] = "Research Publications";
		$this->template->show('research_data', $data);
	}

	public function Funded_Projects()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Research_Funding.pdf	';
		$data['activeMenu'] = "Funded Projects";
		$this->template->show('research_data', $data);
	}

	public function Collaborations_and_MoUs()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'MOUs.pdf';
		$data['activeMenu'] = "Collaborations & MoUs";
		$this->template->show('research_data', $data);
	}

	public function Research_Events()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Conferences.pdf';
		$data['activeMenu'] = "Research Events";
		$this->template->show('research_data', $data);
	}

	public function Research_Incentives_and_Support()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
	...
	public function Student_Research_and_Innovation()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
	...
	public function PhD_Research()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Research_Scholars_List.pdf';
		$data['activeMenu'] = "PhD Research";
		$this->template->show('research_data', $data);
	}
	...
	public function Intellectual_Property()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Patents.pdf';
		$data['activeMenu'] = "Intellectual Property";
		$this->template->show('research_data', $data);
	}

	public function Downloads_Forms()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = '';
		$data['activeMenu'] = "Downloads / Forms";
		$this->template->show('research_data', $data);
	}

	public function Circulars_and_News()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = '';
		$data['activeMenu'] = "Circulars & News";
		$this->template->show('research_data', $data);
	}
	public function Award_Medals_and_Recognition()
	{
		$data['mainMenu'] = 'Research';
		$data['parentMenu'] = false;
		$data['file_name'] = 'Awards_and_Recognitions.pdf';
		$data['file_name1'] = 'Research_Awardees_List.pdf';
		$data['activeMenu'] = "Award Medals and Recognition";
		$this->template->show('research_data', $data);
	}
	...
	public function Humanities()
	{
		$data['mainMenu'] = 'About Us';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Humanities";
		$this->template->show('Humanities', $data);
	}
	...
	{
		$data['page_title'] = "Academic Affairs";
		$data['mainMenu'] = 'Departments';
		$data['dept_name_id'] = '27';
		$data['dept_name'] = 'Academic Affairs';
		$data['dept_id'] = '27';
		$data['parentMenu'] = $this->globals_model->departmentsList()[$data['dept_id']];
		$data['short_name'] = $this->globals_model->departmentShortName()[$data['dept_id']];
		$data["slider_count"] = $this->admin_model->sliders_count($data['dept_id']);
		...
		$this->template->show('academic_affairs', $data);
	}
	...
	public function placements($id)
	{
		...
		$data['Details'] = $this->admin_model->getDetailsbyfieldSort($data['dept_id'], 'dept_id', 'id', 'desc', 'placements')->result();
		$data['departmentsDetails'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'department_id', 'departments_data')->row();
	...
	public function aicte_images($id, $alb)
	{
		$data['mainMenu'] = 'AICTE IDEA-Lab';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Gallery";
		...
		$this->template->show('AICTE_Gallery_Inner', $data);
	}
	...
	public function newsletters($id)
	{
		...
		$data['short_name'] = $this->globals_model->departmentShortName()[$data['dept_id']];
		$data['activeMenu'] = "Newsletters";
		$data['Details'] = $this->admin_model->getDetailsbyfieldSort($data['dept_id'], 'dept_id', 'id', 'desc', 'newsletters')->result();
	...
	public function News_and_Events($id)
	{
		...
		$data['Details'] = $this->admin_model->getDetailsbyfieldSort($data['dept_id'], 'dept_id', 'id', 'desc', 'events')->result();
	...
	public function award_medals_patents()
	{
		$data['mainMenu'] = 'AWARDS, MEDALS, PATENTS & RECOGNITION';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "AWARDS, MEDALS, PATENTS & RECOGNITION";
		$this->template->show('events', $data);
	}
	...
	public function MCE_Federation_University()
	{
		$data['mainMenu'] = 'Gallery';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "Gallery";
		$this->template->show('MCE_Federation_University', $data);
	}
	...
	public function cycle2_Quality_Initiatives()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Quality Initiatives";
		$this->template->show('cycle2_Quality_Initiatives', $data);
	}
	...
	public function cycle2_Qualitative_Matrics()
	{
		$data['mainMenu'] = 'NAAC';
		$data['parentMenu'] = 'IQAC';
		$data['activeMenu'] = "Qualitative Matrics";
		$this->template->show('cycle2_Qualitative_Matrics', $data);
	}
	...
	public function placement_policy_overview()
	{
		$data['page_title'] = "Placement Policy";
		$data['mainMenu'] = 'Training and Placements';
		$data['parentMenu'] = "Training and Placements";
		$data['activeMenu'] = "Placement Policy Overview";
		$data['dept_name_id'] = '21';
		$data['dept_name'] = 'Placement Policy';
		$data['dept_id'] = '21';
		$data['parentMenu'] = $this->globals_model->departmentsList()[$data['dept_id']];
		$data['short_name'] = $this->globals_model->departmentShortName()[$data['dept_id']];
		$data["slider_count"] = $this->admin_model->sliders_count($data['dept_id']);
		$data['sliders'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'dept_id', 'sliders')->result();
		$data['Details'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'dept_id', 'events')->result();
		$data['documents'] = $this->admin_model->getDetailsbyfield2('dept_id', $data['dept_id'], 'type', '1', 'placement_documents')->result();

		$data['departmentsDetails'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'department_id', 'departments_data')->row();

		$this->template->show('placement_policy_overview', $data);
	}
	public function upcoming_placement_drives()
	{
		$data['page_title'] = "Placement Policy";
		$data['mainMenu'] = 'Training and Placements';
		$data['parentMenu'] = "Training and Placements";
		...
		$data['sliders'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'dept_id', 'sliders')->result();
		$data['Details'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'dept_id', 'events')->result();
		$data['documents'] = $this->admin_model->getDetailsbyfield2('dept_id', $data['dept_id'], 'type', '2', 'placement_documents')->result();

		$data['departmentsDetails'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'department_id', 'departments_data')->row();

		$this->template->show('upcoming_placement_drives', $data);
	}
	public function upcoming_skill_development()
	{
		$data['page_title'] = "Placement Policy";
		$data['mainMenu'] = 'Training and Placements';
		$data['parentMenu'] = "Training and Placements";
		...
		$data['sliders'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'dept_id', 'sliders')->result();
		$data['Details'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'dept_id', 'events')->result();
		$data['documents'] = $this->admin_model->getDetailsbyfield2('dept_id', $data['dept_id'], 'type', '3', 'placement_documents')->result();

		$data['departmentsDetails'] = $this->admin_model->getDetailsbyfield($data['dept_id'], 'department_id', 'departments_data')->row();

		$this->template->show('upcoming_skill_development', $data);
	}
	...
	public function ug_programs()
	{
		$data['mainMenu'] = 'Admissions';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "UG Programs";
		$this->template->show('ug_programs', $data);
	}
	public function pg_programs()
	{
		$data['mainMenu'] = 'Admissions';
		$data['parentMenu'] = false;
		$data['activeMenu'] = "PG Programs";
		$this->template->show('pg_programs', $data);
	}
}
